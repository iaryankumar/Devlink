  ...
  return (
    <>
      <section className='h-max py-12 w-full flex items-center justify-center font-primary hero-container'>
        ...
        {/* Left Side div */}
        <div className='h-full w-1/2 hero-child flex flex-col justify-center sm:px-10 px-5 text-left'>
          <h1 className='text-[3.2rem] font-bold leading-14 lDfonts'>From Visuals to Powerful React Applications.</h1>
        ...
        <div className='h-full w-1/2 hero-child flex flex-col items-center justify-center'>
          <div className='sm:h-[230px] h-max lg:w-[550px] w-[95%] flex sm:flex-row flex-col items-center p-1 gap-4 relative'>

            <div className='h-full sm:w-1/2 w-full border-2 border-gray-300 stylishDiv overflow-hidden'>
            ...
            <div className='h-full sm:w-1/2 w-full bg-gray-100 rounded sm:p-6 p-4'>
